    ...
    if (toggleBtn && defaultPlaceholder) {
        ...
        <div id="blog-cooking-anim" class="flex flex-col items-center justify-center py-20 mt-4 rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-100 relative overflow-hidden" style="display:none;">
            <div class="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
                <span class="text-[8rem] md:text-[12rem] font-black text-gray-100 tracking-widest opacity-60">ðŸ³</span>
            </div>
            <div class="relative z-10 flex flex-col items-center gap-4">
                ...
                <p class="text-gray-400 text-lg font-medium mt-2">Estamos preparando artÃ­culos increÃ­bles para ti ðŸ”¬</p>
            </div>
        </div>
        `;
        ...
        toggleBtn.addEventListener('click', () => {
            ...
            if (isOpen) {
                ...
                toggleBtn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"></path></svg>Ocultar artÃ­culos';
            } else {
                defaultPlaceholder.style.display = 'flex';
                cookingBlock.style.display = 'none';
                toggleBtn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>Ver artÃ­culos';
            }
        });
    }
})();
